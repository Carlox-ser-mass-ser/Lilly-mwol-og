...
module.exports = {
    ...
    SESSION: process.env.CONNECTION_CODE === undefined ? '' : process.env.LILLY_MWOLE_CODE,
    ANTİLİNK: process.env.ANTİ_LİNK === undefined ? 'false' : process.env.ANTİ_LİNK,
    AUTOBİO: process.env.AUTO_BİO === undefined ? 'false' : process.env.AUTO_BİO,
    AFN: process.env.ALL_CAPTION === undefined ? 'Made By LILLY-MWOL' : process.env.ALL_CAPTION,
    ...
    GIF_WEL: process.env.GIF_WEL === undefined ? 'https://i.imgur.com/ywJZJqT.mp4' : process.env.GIF_WEL,
    GIF_BYE: process.env.GIF_BYE === undefined ? 'https://i.imgur.com/0uZ3tFX.mp4' : process.env.GIF_BYE,
    ...
    BOTSK: process.env.BOT_NAME === undefined ?'Lilly-MWOLE ' : process.env.BOT_NAME,
    LOGOSK: process.env.ALL_IMG === undefined ? 'https://i.imgur.com/wdYhaBH.jpeg' : process.env.ALL_IMG,
    ...
    SUDO: process.env.SUDO === undefined ? '447405935355,0' : process.env.SUDO,
    DEBUG: DEBUG,
