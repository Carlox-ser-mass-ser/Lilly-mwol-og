...
module.exports = {
    ...
    AFN: process.env.ALL_CAPTION === undefined ? 'Made By carlox & mass-ser' : process.env.ALL_CAPTION,
    ...
    BOTSK: process.env.BOT_NAME === undefined ? 'LILLY-MWOL' : process.env.BOT_NAME,
    ...
    SLINK: process.env.SOCIAL_MEDIA === undefined ? 'https://www.instagram.com/__.carlox.__/' : process.env.SOCIAL_MEDIA,
    ...
    SUDO: process.env.SUDO === undefined ? '918078073223,0,917356835535,0' : process.env.SUDO,
    DEBUG: DEBUG,
