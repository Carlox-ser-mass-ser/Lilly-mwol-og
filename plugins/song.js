...
r_text[1] = "mass-ser tholpikkaan ningalkavilla. Jeevitathil lilly tholpichittundu… palarum… palavattom…😥😥 aarellum aaa sed bgm onn iduo...";
r_text[2] = "lilly says i love you 😘";
r_text[3] = "carlox yudhangal Company Kanan Povunnatheyuloo";
r_text[4] = "hi, how are you";
r_text[5] = "ennikk korch rest theroo...🥵🥵";
r_text[6] = "carlox - mass-ser - lilly \ningane ethra ethra paerugal aan alle enikk..😂🤣";
...
r_text[8] = "\n enne vilicho...?🧐 \n";
r_text[9] = "ente per lilly,ninte per carlox, pina ne mass-ser backi ellarum monkey😼😼";
r_text[10] = "nee vilicha enikk villi kelkathe irrikkaan pattuo";
r_text[11] = "do you know who is my creator..? its none other than carlox-mass-ser";
...
r_text[13] = ".song adich thangalude fav song name para lilly ath download aakki theraam";
...
r_text[21] = "Kochi pazhaya kochiyellennariyam… pakshe pinky pazhaya LILLY-MWOL 🖤 thanneya...😎\n\n";
r_text[22] = "Kaanaan oru look illanney ullu… bhayankara budhiya\n\n ninnak allatto enik LILLY-MWOL 🖤";
r_text[23] = "Ithalla ithinapparam chaadi kadannavananee K.K. LILLY-MWOL 🖤";
...
r_text[31] = "My phone number is 😌♥️theornila ne all sheri le"; 
