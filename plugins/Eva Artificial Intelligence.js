/*Fulleva recoded By Carlox & Mass
*/
...
if (conf.LANG == 'EN') vtalk_dsc = 'Starts to Lilly-mwol voice chat.', reply_eva = '*Reply to Any Voice Message!*'
...
var succ_off = ''
if (conf.LANG == 'TR') {
    fulleva_dsc = 'Tam fonksiyonel Lilly-mwol özelliklerini aktif eder. Hesabınızı bir chatbota dönüştürün!'
    already_on = 'Lilly-mwol yapay zekası halihazırda tüm fonksiyonları etkin.'
    already_off = 'Lilly-mwol yapay zekası halihazırda yarı fonksiyonel çalışıyor.'
    succ_on = 'Lilly-mwol, Tam Fonksiyonel Olarak Açıldı! Lütfen Biraz Bekleyin! ✅'
    succ_off = 'Lilly-mwol, Yarı Fonksiyonel Olarak Ayarlandı! Lütfen Biraz Bekleyin! ☑️'
}
if (conf.LANG == 'EN') {
    fulleva_dsc = 'Activates full functional Lilly-mwol features. Turn your account into a ai chatbot!'
    already_on = 'Lilly-mwol artificial intelligence is already fully functional.'
    already_off = 'Lilly-mwol artificial intelligence is currently running semi-functional.'
    succ_on = 'Lilly-mwol Opened Fully Functionally! Please wait a bit! ✅'
    succ_off = 'Lilly-mwol Set to Semi-Functional! Please wait a bit! ☑️'
}
if (conf.LANG == 'ML') {
